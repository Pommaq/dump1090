 ...
 * structure. */
modesMessage::modesMessage(unsigned char *msg, uint64_t seq) {
...
void modesMessage::decodeMessage() {
...
int modesMessage::errorfix(bool twobitfix) {
    ...
    if (!this->crcok && Modes.check_crc == 0)
        // Message is bad. Stop and let the creating function handle it.
        return -1;
    return 0;
}
